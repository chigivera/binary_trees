 ...
 */
static size_t binary_tree_height_b(const binary_tree_t *tree)
{
...
int binary_tree_balance(const binary_tree_t *tree)
{
    ...
    left_height = tree->left ? 1 + (int)binary_tree_height_b(tree->left) : 0;
    right_height = tree->right ? 1 + (int)binary_tree_height_b(tree->right) : 0;
